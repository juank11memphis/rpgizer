    ...
    >
      <div>
        ...
        <textarea
          ...
          onKeyDown={(event) => {
            if (!shouldSubmitAnswerFromKeyDown(event) || sendDisabled) {
              return;
            }
...
export type AnswerComposerKeyDownInput = {
  key: string;
  shiftKey: boolean;
  nativeEvent?: {
    isComposing?: boolean;
...
export function shouldSubmitAnswerFromKeyDown(
  event: AnswerComposerKeyDownInput,
): boolean {
