...
export function normalizeAdventurePlannerEvalSuiteResult(
...
export function normalizeUnexpectedEvalSuiteError(error: unknown, durationMs: number): EvalSuiteRunResult {
