...
export function buildFixture(
  ...
  return {
    ...
    interviewOutputArtifact: {
      ...
      motivationDetails: ["Connect with neighbors"],
      ...
      currentSkillOrBaseline: "Knows vocabulary but freezes when speaking.",
      ...
      missingResources: ["Conversation prompt list"],
      safetyBoundaries: ["Educational language learning guidance only"],
      preferences: ["Cozy tavern quest tone"],
      dislikesOrAvoidances: ["Avoid guaranteed fluency claims"],
      priorAttempts: ["Has learned vocabulary"],
      confidenceGaps: ["Freezes when speaking"],
      examplesOrInspirations: ["Ten-minute coffee chat"],
      firstMilestoneReadiness: "Ready for a first speaking-practice milestone.",
