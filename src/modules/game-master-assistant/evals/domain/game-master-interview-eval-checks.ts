...
function messageTargetsSignal(
  ...
  switch (signal) {
    ...
    case "pastFriction":
      return /\b(tried|before|friction|snag|obstacle|block|stuck|stick(?:ing)?|struggl|tripped|trip you up|trip up|most likely to|remembering|forgetting|balance|off track|throws? you off|overwhelm|gets? in the way|hard|difficult)\b/i.test(
        message,
      );
    case "constraints":
